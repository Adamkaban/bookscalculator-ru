...
<BaseLayout>
  ...
  <style>
    ...
    .difficulty-hard { background-color: #fee2e2; color: #dc2626; }
  </style>
  ...
  <meta property="og:title" content={book.seo.meta_title}>
  <meta property="og:description" content={book.seo.meta_description}>
  <meta property="og:site_name" content="BooksCalculator.ru">
  <meta property="article:author" content={book.author}>
  <meta property="article:published_time" content={new Date().toISOString()}>
  <meta property="article:section" content={book.basic_info.genre}>

  <!-- Twitter Card -->
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content={book.seo.meta_title}>
  <meta name="twitter:description" content={book.seo.meta_description}>
  ...
  <script type="application/ld+json">
    {
      ...
      "numberOfPages": {book.basic_info.pages},
      "genre": "{book.basic_info.genre}",
      "datePublished": "{book.basic_info.year_written}",
      "description": "{book.seo.meta_description}",
      "keywords": "{book.seo.keywords.join(', ')}",
      "timeRequired": "{book.basic_info.reading_time}",
      "educationalUse": "{book.basic_info.recommended_age}"
    }
  </script>
</BaseLayout>
`;
